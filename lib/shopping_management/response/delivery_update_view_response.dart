...
class DeliveryUpdateViewResponse extends BaseResponse {
  int status;
  DeliveryUpdateView data;

  DeliveryUpdateViewResponse.fromJson(Map<String, dynamic> json)
      : super.fromJson(json) {
    status = json['Status'];
    data = json['Data'] != null
        ? new DeliveryUpdateView.fromJson(json['Data'])
        : null;
  }
...
class DeliveryUpdateView {
  ...
  DeliveryUpdateView({this.contract, this.lines});

  DeliveryUpdateView.fromJson(Map<String, dynamic> json) {
