...
class DeliveryHistoryDetailResponse extends BaseResponse {
  DeliveryHistoryDetailModel data;

  DeliveryHistoryDetailResponse.fromJson(Map<String, dynamic> json)
      : super.fromJson(json) {
    status = json['Status'];
    data = json['Data'] != null
        ? new DeliveryHistoryDetailModel.fromJson(json['Data'])
        : null;
  }
...
class DeliveryHistoryDetailModel {
  Commodity commodity;
  List<Histories> histories;

  DeliveryHistoryDetailModel({this.commodity, this.histories});

  DeliveryHistoryDetailModel.fromJson(Map<String, dynamic> json) {
