...
const kBlue1 = Color(0xFF1D87DA);
const kBlue2 = Color(0xFF0069A0);
const kBlack1 = Color(0xFF202020);
const kGrey1 = Color(0xffEFF0F5);
const kGrey2 = Color(0xFF616161);
const kGrey3 = Color(0xFFF7F7F7);
const kGrey4 = Color(0xFFF2F2F2);
const kGrey5 = Color(0xFFF6F6F6);
const kGrey6 = Color(0xFF969696);
const kGrey7 = Color(0xFF464646);
const kGrey8 = Color(0xFF8F8F8F);
const kOrange1 = Color(0xffFEC106);
const kOrange2 = Color(0xffFCA549);

const kWorkCommandStatusColor = {
  "pending": "#FCA549",
  "cancelled": "#D63F31",
  "performTask": "#2196F3",
  "waitingConfirm": "#CFBA00",
  "notFinished": "#FCA549",
  "confirmed": "#0069A0",
  "completedNotDone": "#02C22C",
  "completedDone": "#02C22C"
};

const kWorkSheetStatusColor = {
  "pending": "#FCA549",
  "rePerformTask": "#2196F3",
  "performTask": "#2196F3",
  "waitingConfirm": "#CFBA00",
  "notFinished": "#FCA549",
  "confirmed": "#0069A0",
...
const kRequireStatusColor = {"inProgress": "#FCA549", "finished": "#0069A0"};

const kConfirmCommanderStatus = {
  "notConfirm": "#FCA549",
  "confirmed": "#02C22C"
};

const kManipulationSheetsStatusColor = {
  "electrical_safety": "#2196F3",
  "mechanical_safety": "#FEC106",
};

const kManagerReceivingOilStatusColor = {
  "receiptOfFuel": "#D63F31",
  "oilSuddenlyBought": "#2196F3",
  "quarterlyPlan": "#0069A0",
};

const kManagerReceivingLimestoneStatusStatus = {
  "notComplete": "#FCA549",
  "complete": "#02C22C",
};
