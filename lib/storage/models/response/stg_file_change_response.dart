...
class StgFileChangeResponse extends BaseResponse {
  DataStgFileChange data;

  StgFileChangeResponse.fromJson(Map<String, dynamic> json)
      : super.fromJson(json) {
    data = json['Data'] != null
        ? new DataStgFileChange.fromJson(json['Data'])
        : null;
  }
...
class DataStgFileChange {
  ...
  DataStgFileChange.fromJson(Map<String, dynamic> json) {
    // iD = json['ID'];
    path = json['Path'];
    size = json['Size'];
    name = json['Name'];
