...
import 'package:workflow_manager/procedures/widgets/photoview/photo_view.dart'
    show PhotoView, PhotoViewHeroAttributes, PhotoViewImageTapDownCallback, PhotoViewImageTapUpCallback, PhotoViewScaleState, PhotoViewState, ScaleStateCycle;
import 'package:workflow_manager/procedures/widgets/photoview/src/controller/photo_view_controller.dart';
import 'package:workflow_manager/procedures/widgets/photoview/src/controller/photo_view_controller_delegate.dart';
import 'package:workflow_manager/procedures/widgets/photoview/src/controller/photo_view_scalestate_controller.dart';
import 'package:workflow_manager/procedures/widgets/photoview/src/utils/photo_view_utils.dart';
import 'package:workflow_manager/procedures/widgets/photoview/src/core/photo_view_gesture_detector.dart';
import 'package:workflow_manager/procedures/widgets/photoview/src/core/photo_view_hit_corners.dart';

import '../../../pdf/signal_screen.dart';
...
class PhotoViewCoreState extends State<PhotoViewCore>
  ...
  double updateingDx = 0;

  void onScaleUpdate(ScaleUpdateDetails details) {
    final double newScale = _scaleBefore * details.scale;
    final Offset delta = details.focalPoint - _normalizedPosition;
    updateingDx = clampPosition(position: delta * details.scale).dx;
    updateScaleStateFromNewScale(newScale);
    // dx-=clampPosition(position: delta * details.scale).dx-dxStart;
    // print("dxnew $dx    $dxStart      ${clampPosition(position: delta * details.scale).dx-dxStart}");
    //
    updateMultiple(
      scale: newScale,
        ...
        builder: (
          ...
          if (snapshot.hasData) {
            ...
            if (widget.disableGestures) {
              context
                  .findRootAncestorStateOfType<SignalScreenState>()
                  .onPositionChanged(imageKey, controller,context
                  .findAncestorWidgetOfExactType<PhotoView>().index);
              return child;
            }
            context
                .findRootAncestorStateOfType<SignalScreenState>()
